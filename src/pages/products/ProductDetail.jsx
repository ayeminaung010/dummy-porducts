          ...
          <div className="flex justify-evenly items-center flex-col md:flex-row ">
            ...
            <div className=" flex flex-col gap-5 justify-between items-center ">
              <div className=" border-2">
                <img
                  src={data?.thumbnail}
                  className="thumbnail rounded h-80 w-96 object-full "
                  alt=""
                />
              </div>
              <div className=" flex flex-wrap gap-2 justify-evenly">
                {data?.images.map((i, index) => (
                  <img
                    ...
                    className="rounded w-12 h-12  md:w-20 md:h-20 object-cover"
                  />
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-wrap flex-col gap-5 px-2 my-3 md:w-5/12">
              ...
              <div className=" flex flex-wrap gap-5">
                <div className=" flex flex-wrap gap-3">
                  <button className=" btn btn-outline" onClick={decreaseBtn}>
                    -
                  </button>
                  <input
                    type="number"
                    className="input w-28 font-semibold   max-w-xs"
                    value={count}
                    onChange={handleChange}
                  />
                  <button className=" btn btn-outline" onClick={increaseBtn}>
                    +
                  </button>
                </div>
                <div className="">
